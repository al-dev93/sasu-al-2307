...
const worksData: WorksData = [
  {
    ...
    picture: '/app/src/assets/pictures/FishEye.png',
  ...
  },
  {
    ...
    picture: '/app/src/assets/pictures/les_petits_plats.png',
  ...
  },
  {
    ...
    picture: '/app/src/assets/pictures/sport_see.png',
  ...
  },
  {
    title: 'Kasa',
    description:
      'L’application web Kasa s’adresse aux particuliers désireux de louer leurs appartements. Développée avec React, elle propose des composants évolués tels que des cartes pour afficher un apperçu des locations dans une galerie, des collapses pour dérouler ou masquer des informations, un slider pour faire défiler les photos des appartements. Elle dispose d’une page d’accueil, d’une page appartement dont le contenu est créé dynamiquement selon la sélection , d’une page à propos et d’une page d’erreur. navigation est confiée à React Router.',
    picture: '/app/src/assets/pictures/kasa.png',
